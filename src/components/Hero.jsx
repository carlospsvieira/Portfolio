      ...
      <div className="w-[80%] h-screen border-x-[2px] border-t-[2px] border-zinc-600 hero">
        <div className="flex flex-col items-center text-white gap-4">
          ...
          <p>
            ...
            a passion for creating visually stunning and functional applications.
            Explore my portfolio, which is one of my projects, to see examples
            of my work and learn more about my experience and skills.
          </p>
