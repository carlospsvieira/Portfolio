      ...
      <div className="w-[80%] h-screen border-x-[2px] border-zinc-600 story text-white">
        ...
        <AnimationOnScroll animateIn="animate__slideInUp">
          <div className="story-container">
            ...
            />
            <span>
              Moved from Brazil to Canada and worked mostly in the telecom
              industry with mobile network sales, met some of the nicest people
              and technology was around me 24/7.
            </span>
          </div>
        </AnimationOnScroll>
        <AnimationOnScroll animateIn="animate__slideInUp">
          <div className="story-container">
            ...
            <span>
              ...
              home, I saw an opportunity to be closer to my family during this
              time back in Brazil and pursue education and a career in web
              development.
            </span>
          </div>
        </AnimationOnScroll>
        <AnimationOnScroll animateIn="animate__slideInUp">
          <div className="story-container">
            ...
            <span>
              ...
              really love what I do, and more so taking on new challenges
